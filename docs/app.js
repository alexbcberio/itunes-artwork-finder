    ...
    [
      _c("header", [
        _c("h1", { attrs: { id: "title" } }, [
          _vm._v(_vm._s(_vm.$t("terms.title")))
        ]),
        _vm._v(" "),
        _c(
          "select",
          {
            ...
            attrs: {
              id: "changeLocale",
              "aria-label": _vm.$t("terms.locale-label")
            },
            on: {
          ...
          _vm._l(_vm.$i18n.availableLocales, function(lang, i) {
            return _c(
              "option",
              {
                key: "Lang" + i,
                attrs: { checked: _vm.$i18n.locale == lang ? true : false },
                domProps: { value: lang }
              },
              [_vm._v(_vm._s(_vm.$i18n.messages[lang].language))]
            )
          }),
          0
        )
      ...
      _c(
        "form",
        {
          attrs: { action: "javascript:", method: "post", id: "search-iTunes" },
        ...
        [
          _c("input", {
            attrs: {
              type: "text",
              name: "term",
              placeholder: _vm.$t("terms.search-iTunes-form.term-placeholder"),
              autofocus: "",
              autocomplete: "off",
              spellcheck: "false",
              "aria-label": _vm.$t("terms.search-iTunes-form.term-placeholder")
            },
            domProps: { value: _vm.formData ? _vm.formData.get("term") : "" }
          }),
          _vm._v(" "),
          _c("input", {
            ...
            domProps: {
              value: _vm.formData
                ? _vm.formData.get("country")
                : _vm.$t("terms.search-iTunes-form.country-code")
            }
          }),
          _vm._v(" "),
          _c("div", { staticClass: "inline" }, [
            _c(
              "select",
              {
                attrs: {
                  name: "entity",
                  "aria-label": _vm.$t("terms.search-iTunes-form.entity-label")
                },
                domProps: {
                  value: _vm.formData
                    ? _vm.formData.get("entity")
                    : _vm.defaults.entity
                }
              },
              [
            ...
            _c("input", {
              attrs: {
                ...
                min: "1",
                max: "200",
                placeholder: _vm.$t("terms.search-iTunes-form.result-limit"),
                "aria-label": "$t('terms.search-iTunes-form.result-limit')"
              },
              domProps: {
                value: _vm.formData
                  ? _vm.formData.get("limit")
                  : _vm.defaults.limit
              }
            })
          ]),
          ...
          _c("button", { attrs: { type: "submit", name: "submit" } }, [
            _vm._v(
              "\n            " +
                _vm._s(_vm.$t("terms.search-iTunes-form.submit-text")) +
                "\n        "
            )
          ])
        ]
      ...
      _c(
        "main",
        { style: { display: _vm.resultsFound === null ? "flex" : "" } },
        [
          _vm.resultsFound === null
            ? _c("div", { attrs: { id: "welcome-guide" } }, [
                _c("div", { staticClass: "step-1" }, [
                  _c("img", {
                    attrs: { src: "img/pen-icon.svg", alt: "Pen icon" }
                  }),
                  _vm._v(" "),
                  _c("h2", [
                    _vm._v(_vm._s(_vm.$t("terms.welcome-guide.step-1.title")))
                  ]),
                  _vm._v(" "),
                  _c("p", [
                    _vm._v(_vm._s(_vm.$t("terms.welcome-guide.step-1.text")))
                  ])
                ]),
                _vm._v(" "),
                _c("div", { staticClass: "step-2" }, [
                  _c("img", {
                    attrs: { src: "img/search-icon.svg", alt: "Search icon" }
                  }),
                  _vm._v(" "),
                  _c("h2", [
                    _vm._v(_vm._s(_vm.$t("terms.welcome-guide.step-2.title")))
                  ]),
                  _vm._v(" "),
                  _c("p", [
                    _vm._v(_vm._s(_vm.$t("terms.welcome-guide.step-2.text")))
                  ])
                ]),
                _vm._v(" "),
                _c("div", { staticClass: "step-3" }, [
                  _c("img", {
                    attrs: {
                      src: "img/image-file-icon.svg",
                      alt: "Image file icon"
                    }
                  }),
                  _vm._v(" "),
                  _c("h2", [
                    _vm._v(_vm._s(_vm.$t("terms.welcome-guide.step-3.title")))
                  ]),
                  _vm._v(" "),
                  _c("p", [
                    _vm._v(_vm._s(_vm.$t("terms.welcome-guide.step-3.text")))
                  ])
                ])
              ])
            : _vm._e(),
          ...
          _c(
            ...
            { attrs: { id: "response" } },
            [
              !_vm.searching && _vm.resultsFound === false
                ? _c("p", { staticClass: "not-found" }, [
                    _vm._v(_vm._s(_vm.$t("terms.iTunes-search.not-found")))
                  ])
                : _vm._e(),
              _vm._v(" "),
              _vm._l(_vm.results, function(result, i) {
                return _c("result-item", {
                  key: i,
                  attrs: { result: result },
                  on: { preview: _vm.previewItem }
                })
              }),
              _vm._v(" "),
              _c("div", { staticStyle: { width: "100%", height: "1rem" } }),
              _vm._v(" "),
              _vm.searching ? _c("loader") : _vm._e()
            ],
            2
          ),
          _vm._v(" "),
          _vm.displayToTop && !_vm.selectedItem.open
            ? _c(
                "div",
                {
                  attrs: { id: "scrollTop" },
        ...
        directives: [
          {
            name: "show",
            rawName: "v-show",
            value: _vm.selectedItem.open,
            expression: "selectedItem.open"
          }
        ],
        attrs: { title: _vm.selectedItem.title, src: _vm.selectedItem.image },
        on: {
          close: function($event) {
            _vm.selectedItem.open = false
          }
        }
      }),
      _vm._v(" "),
      _vm.showAnalyticsConsent
        ? _c("analytics-consent", {
            on: {
              close: function($event) {
                _vm.showAnalyticsConsent = false
              }
            }
          })
        : _vm._e(),
      ...
      _c("footer", {
        domProps: {
          innerHTML: _vm._s(
            _vm.$t("terms.footer", {
              githubUsername: "alexbcberio",
              githubRepoName: "itunes-artwork-finder"
            })
          )
        }
      })
...
var staticRenderFns = [
  function() {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("optgroup", { attrs: { label: "Movie" } }, [
      _c("option", { attrs: { value: "movieArtist" } }, [
        _vm._v("Movie Artist")
      ]),
      _vm._v(" "),
  ...
  function() {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("optgroup", { attrs: { label: "Podcast" } }, [
      _c("option", { attrs: { value: "podcastAuthor" } }, [
        _vm._v("Podcast Author")
      ]),
      _vm._v(" "),
      _c("option", { attrs: { value: "podcast" } }, [_vm._v("Podcast")])
    ])
  },
  function() {
    var _vm = this
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("optgroup", { attrs: { label: "Music" } }, [
      _c("option", { attrs: { value: "musicArtist" } }, [
        _vm._v("Music Artist")
      ]),
      _vm._v(" "),
      _c("option", { attrs: { value: "musicTrack" } }, [_vm._v("Music Track")]),
      _vm._v(" "),
      _c("option", { attrs: { value: "album" } }, [_vm._v("Album")]),
      _vm._v(" "),
      _c("option", { attrs: { value: "musicVideo" } }, [_vm._v("Music Video")]),
      _vm._v(" "),
      _c("option", { attrs: { value: "mix" } }, [_vm._v("Mix")]),
      _vm._v(" "),
      _c("option", { attrs: { value: "song" } }, [_vm._v("Song")])
    ])
  },
  function() {
    var _vm = this
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("optgroup", { attrs: { label: "Music Video" } }, [
      _c("option", { attrs: { value: "musicArtist" } }, [
        _vm._v("Music Artist")
      ]),
      _vm._v(" "),
  ...
  function() {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("optgroup", { attrs: { label: "audiobook" } }, [
      _c("option", { attrs: { value: "audiobookAuthor" } }, [
        _vm._v("Audiobook Author")
      ]),
      _vm._v(" "),
      _c("option", { attrs: { value: "audiobook" } }, [_vm._v("Audiobook")])
    ])
  },
  function() {
    var _vm = this
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("optgroup", { attrs: { label: "Short Film" } }, [
      _c("option", { attrs: { value: "shortFilmArtist" } }, [
        _vm._v("Short Film Artist")
      ]),
      _vm._v(" "),
      _c("option", { attrs: { value: "shortFilm" } }, [_vm._v("Short Film")])
    ])
  },
  function() {
    var _vm = this
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("optgroup", { attrs: { label: "TV Show" } }, [
      _c("option", { attrs: { value: "tvEpisode" } }, [_vm._v("TV Episode")]),
      _vm._v(" "),
      _c("option", { attrs: { value: "tvSeason" } }, [_vm._v("TV Season")])
    ])
  },
  function() {
    var _vm = this
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("optgroup", { attrs: { label: "Software" } }, [
      _c("option", { attrs: { value: "software" } }, [_vm._v("Software")]),
      _vm._v(" "),
      _c("option", { attrs: { value: "iPadSoftware" } }, [
        _vm._v("iPad Software")
      ]),
      _vm._v(" "),
      _c("option", { attrs: { value: "macSoftware" } }, [
        _vm._v("mac Software")
      ])
    ])
  },
  function() {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("optgroup", { attrs: { label: "eBook" } }, [
      _c("option", { attrs: { value: "ebook" } }, [_vm._v("eBook")])
    ])
  },
  function() {
    var _vm = this
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("optgroup", { attrs: { label: "all" } }, [
      _c("option", { attrs: { value: "movie" } }, [_vm._v("Movie")]),
      _vm._v(" "),
      _c("option", { attrs: { value: "album" } }, [_vm._v("Album")]),
      _vm._v(" "),
      _c("option", { attrs: { value: "allArtist" } }, [_vm._v("All Artist")]),
      _vm._v(" "),
      _c("option", { attrs: { value: "podcast" } }, [_vm._v("Podcast")]),
      _vm._v(" "),
      _c("option", { attrs: { value: "musicVideo" } }, [_vm._v("Music Video")]),
      ...
      _c("option", { attrs: { value: "tvSeason" } }, [_vm._v("TV Season")]),
      _vm._v(" "),
      _c("option", { attrs: { value: "allTrack" } }, [_vm._v("All Track")])
    ])
  }
]
...
;// CONCATENATED MODULE: ./src/exception/NoNetworkException.js
...
;// CONCATENATED MODULE: ./src/exception/NoTermException.js
class NoTermException extends Error {
    constructor(message) {
        super();
...
;// CONCATENATED MODULE: ./src/class/iTunesAPI.js
...
;// CONCATENATED MODULE: ./src/components/AnalyticsConsent.js


vue_common_prod_default().component("AnalyticsConsent", {
  data: function() {
    return {
      showMoreInfo: false
    };
...
vue_common_prod_default().component("Loader", {
  template: `
  <div class="loader">
    <span></span>
    <span></span>
...
vue_common_prod_default().component('Overlay', {
  props: [
    "title",
    "listenKeyboard",
    "preventClose"
...
;// CONCATENATED MODULE: ./src/components/OverlayImage.js


vue_common_prod_default().component('OverlayImage', {
  props: [
    "src",
    "title"
  ],
...
;// CONCATENATED MODULE: ./src/components/ResultItem.js


vue_common_prod_default().component('ResultItem', {
  props: ['result'],
  methods: {
...
vue_common_prod_default().use(vue_i18n_esm);

vue_common_prod_default().use((vue_matomo_default()), {
...
const src_app = new (vue_common_prod_default())({
    i18n,
    el: "#app",
...
/******/ 	(() => {
/******/ 		__webpack_require__.h = () => "9509e05ccceaa0295fe0"
/******/ 	})();
/******/ 	
...
/******/ 	(() => {
/******/ 		var inProgress = {};
/******/ 		var dataWebpackPrefix = "itunes-artwork-finder:";
...
/******/ 		}
/******/ 		
/******/ 		self["webpackHotUpdateitunes_artwork_finder"] = (chunkId, moreModules, runtime) => {
